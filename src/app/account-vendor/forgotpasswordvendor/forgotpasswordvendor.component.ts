...
@Component({
  selector: 'app-forgotpasswordvendor',
  templateUrl: './forgotpasswordvendor.component.html',
  styleUrls: ['./forgotpasswordvendor.component.scss']
})
export class ForgotpasswordvendorComponent {
  ...
  submit() {
    ...
    let body = new HttpParams;
    body = body.set("vendor_contact", obj.mobile_number);
...
//     this.contact_no = sessionStorage.getItem('contact_no');
    ...
    {
      this.dataservice.forgotpasswordvendor(body).subscribe((res) => {
