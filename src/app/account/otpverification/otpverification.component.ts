...
export class OtpverificationComponent {
  ...
  // GenerateOtp() {
  //   var mbb = new String(this.contact_number);
  //   if (mbb.length != 10) {
  //     setTimeout(() => {}, 100);
  ...
  //   var messege =
  //     'Your verification code for LocalFarm Registration is: ' +
  //     this.codeGenerated +
  //     ' \nRegards, LocalFarm';

  //   //  --------- send otp ------------------
  //   let body = new HttpParams();
  //   body = body.set('number', this.contact_number);
  //   body = body.set('messege', this.codeGenerated);
  //   this.dataservice.sendotp(body).subscribe((rrr) => {
  //     alert(rrr);
  //   });
  //   sessionStorage.setItem('contact_number', this.contact_number);
  //   sessionStorage.setItem('codeGenerated', this.codeGenerated);
  //   alert(
  //     sessionStorage.getItem('contact_number') +
  //       ' ' +
  //       sessionStorage.getItem('codeGenerated')
  //   );
  // }
GenerateOtp() {
